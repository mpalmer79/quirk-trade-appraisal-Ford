...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Ford Braintree"],
    ["successTitle", "¡Gracias! - Quirk Ford Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Ford Braintree se pondrá en contacto con usted en breve."]
  ]);
